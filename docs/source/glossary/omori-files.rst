...
:file:`C:\Program Files (x86)\Steam\steamapps\common\OMORI` if you installed
OMORI on your :file:`C:` drive with Steam.
...
.. glossary::
    ...
    js/ 
        ...
        plugins/
            ...
            `Info on how to work with .js files <https://omori.wiki.mods.one/modding:file-types#js_-_javascript>`__
            
            Contents and details: `www/js/plugins <https://omori.wiki.mods.one/modding:www-js-plugins>`__
    ...
    index.html 
        ...
        for the game (main.js). 
        
        This file, and by extension, the game, doesn't
