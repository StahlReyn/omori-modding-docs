...
**NOTE: THIS REQUIRES THE USE OF RPG Maker MV**
...
Here you can change the Items an enemy drops, and the rate at which they
drop them.
...
Though it is to note that Omori heavily overrides the plugin. {% endhint
%}
