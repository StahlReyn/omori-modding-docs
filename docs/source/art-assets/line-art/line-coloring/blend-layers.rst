...
This is the least efficient type of filtering, but the most accessible
in art programs, as it only requires blend layers.

Start off with monochrome sketch, and on above put in Overlay or Color
Dodge layer filled with pure saturated color. In headspace case, blue.
