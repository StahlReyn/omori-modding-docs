...
default, when you upload a mod to the site, it will be under the
`Creative Commons Attribution-NonCommercial-NoDerivatives 4.0
International
License <https://creativecommons.org/licenses/by-nc-nd/4.0/>`__\ *.*
This is an example of what you will see on the bottom of every mod page:

.. figure:: /images/licenseguide_1.jpg
   :alt: Licensing information screen
...
.. figure:: /images/licenseguide_2.jpg
   :alt: A screenshot of License, Security, Removal

   A screenshot of License, Security, Removal

Here, you can put the name of the license and a link to the terms.

.. figure:: /images/licenseguide_3.jpg
   :alt: A screenshot of a license link

   A screenshot of a license link
