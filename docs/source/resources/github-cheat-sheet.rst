...
| For most people’s purposes, it may be easier to get Github Desktop
  with a user-friendly UI.
| `Download GitHub Desktop <https://desktop.github.com/download/>`__
...
+-----------------------------------+-----------------------------------+
| git push -f origin HEAD^:master   | Undo push BUT leaves local change |
|                                   | intact                            |
+-----------------------------------+-----------------------------------+
...
especially if it merges an updated upstream into a topic branch - Stack
Overflow <https://stackoverflow.com/questions/19085807/please-enter-a-commit-message-to-explain-why-this-merge-is-necessary-especially>`__
